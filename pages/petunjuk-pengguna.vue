		...
		<div class="absolute w-screen top-0 left-0 min-h-screen flex flex-col ">
			...
			<div class="bg-white/70 flex-1 rounded-se-3xl rounded-ss-3xl flex flex-col px-5 pt-6 pb-20 justify-between">
				<div class="grid gap-6">
					<div class="bg-white rounded-3xl flex flex-col items-center justify-center px-4 py-4">
						<NuxtImg src="img/server.png" class="w-5/12" />
					</div>
					<div class="px-8">
						<p class="text-center">Data rekaman akan otomatis tersimpan kedalam server. Pengguna  bisa mengakses seluruh file rekaman tersebut dengan masuk ke menu “Penyimpanan”</p>
					</div>
				</div>
				<div class="flex justify-between">
					<button class="text-white bg-gradient-to-br from-purple-950 to-rose-700 px-7 py-1.5 rounded-lg">Kembali</button>
					<button class="text-white bg-gradient-to-br from-purple-950 to-rose-700 px-7 py-1.5 rounded-lg">Lanjut</button>
				</div>
			</div>
		</div>
	</div>
